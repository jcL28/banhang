            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Chỉnh Sửa Loại Tài Khoản Nhân Viên</h1>
                    </div>

                    <!-- Edit Employee Form -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="{{ route('admin.employee.edit.post', $employee->id) }}" method="POST">
                                @csrf
                                @method('POST')
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <select name="type" id="type" class="form-control">
                                                        <option value="1"
                                                            {{ $employee->type == 1 ? 'selected' : '' }}>Khách Hàng
                                                        </option>
                                                        <option value="2"
                                                            {{ $employee->type == 2 ? 'selected' : '' }}>Nhân Viên
                                                        </option>
                                                    </select>
                                                </div>
                                            </td>
